...
public interface IVPages extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(9)
  @DefaultMethod
  org.belle.topit.visio.base.IVPage item(
  ...
  @VTID(11)
  org.belle.topit.visio.base.IVPage add();
  ...
  @VTID(17)
  org.belle.topit.visio.base.IVPage itemU(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
  ...
  @VTID(20)
  org.belle.topit.visio.base.IVPage itemFromID(
    int nID);
