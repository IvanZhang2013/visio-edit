...
public interface IVValidationRuleSet extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.VisRuleSetFlags
   */

  @DISPID(1610743821) //= 0x6002000d. The runtime will prefer the VTID if present
  @VTID(20)
  org.belle.topit.visio.base.VisRuleSetFlags ruleSetFlags();
   ...
   * </p>
   * @param ruleSetFlags Mandatory test.VisRuleSetFlags parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type test.IVValidationRules
   */

  @DISPID(1610743823) //= 0x6002000f. The runtime will prefer the VTID if present
  @VTID(22)
  org.belle.topit.visio.base.IVValidationRules rules();


  @VTID(22)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVValidationRules.class})
  org.belle.topit.visio.base.IVValidationRule rules(
