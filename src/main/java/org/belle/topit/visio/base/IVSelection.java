...
public interface IVSelection extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(10)
  org.belle.topit.visio.base.IVShape item16(
    short index);
  ...
  /**
   * @param sheetObject Mandatory test.IVShape parameter.
  ...
  @VTID(51)
  void select(
    org.belle.topit.visio.base.IVShape sheetObject,
    short selectAction);
  ...
  @VTID(61)
  org.belle.topit.visio.base.IVShape drawRegion(
    double tolerance,
    short flags,
  ...
  @VTID(66)
  org.belle.topit.visio.base.IVShape primaryItem();
  ...
  @VTID(72)
  org.belle.topit.visio.base.IVSelection duplicate();
  ...
  void rotate(
    ...
    @Optional @DefaultValue("0") org.belle.topit.visio.base.VisRotationTypes rotationType,
  ...
  /**
   * @param alignHorizontal Mandatory test.VisHorizontalAlignTypes parameter.
   * @param alignVertical Mandatory test.VisVerticalAlignTypes parameter.
  ...
  @VTID(77)
  void align(
    org.belle.topit.visio.base.VisHorizontalAlignTypes alignHorizontal,
    org.belle.topit.visio.base.VisVerticalAlignTypes alignVertical,
    @Optional @DefaultValue("0") boolean glueToGuide);


  /**
   * @param distribute Mandatory test.VisDistributeTypes parameter.
   * @param glueToGuide Optional parameter. Default value is false
   */
  ...
  @VTID(78)
  void distribute(
    org.belle.topit.visio.base.VisDistributeTypes distribute,
    @Optional @DefaultValue("0") boolean glueToGuide);
  ...
  /**
   * @param flipDirection Mandatory test.VisFlipDirection parameter.
  ...
  @VTID(82)
  void flip(
    org.belle.topit.visio.base.VisFlipDirection flipDirection,
    @Optional @DefaultValue("0") org.belle.topit.visio.base.VisFlipTypes flipType,
    @Optional @DefaultValue("0") boolean blastGuards,
    @Optional @DefaultValue("0") double pinX,
    @Optional @DefaultValue("0") double pinY,
    @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object pinUnitsNameOrCode);
  ...
  int[] getIDs();
    ...
    @VTID(98)
    org.belle.topit.visio.base.IVSelection selectionForDragCopy();


    @VTID(98)
    @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVSelection.class})
    org.belle.topit.visio.base.IVShape selectionForDragCopy(
      int index);
    ...
    /**
     * @param formatType Mandatory test.VisContainerFormatType parameter.
    ...
    int[] setContainerFormat(
      org.belle.topit.visio.base.VisContainerFormatType formatType,
