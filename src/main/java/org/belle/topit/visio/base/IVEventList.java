...
public interface IVEventList extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type test.IVEvent
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  org.belle.topit.visio.base.IVEvent item(
    short index);
  ...
  @VTID(11)
  org.belle.topit.visio.base.IVEvent add(
    short eventCode,
    short action,
  ...
  @VTID(12)
  org.belle.topit.visio.base.IVEvent addAdvise(
    short eventCode,
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVEvent itemFromID(
    int objectID);
