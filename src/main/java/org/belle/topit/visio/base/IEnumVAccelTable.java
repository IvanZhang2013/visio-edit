...
public interface IEnumVAccelTable extends Com4jObject {
   ...
   * @param rgelt Mandatory Holder<test.IVAccelTable> parameter.
  ...
  void next(
    int celt,
    Holder<org.belle.topit.visio.base.IVAccelTable> rgelt,
  ...
  /**
   * @return  Returns a value of type test.IEnumVAccelTable
   */

  @VTID(6)
  org.belle.topit.visio.base.IEnumVAccelTable clone();
