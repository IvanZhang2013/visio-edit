...
public interface IVPage extends Com4jObject {
  ...
  @VTID(24)
  org.belle.topit.visio.base.IVPage backPageAsObj();
   ...
   * </p>
   * @return  Returns a value of type test.IVLayers
   */

  @DISPID(19) //= 0x13. The runtime will prefer the VTID if present
  @VTID(29)
  org.belle.topit.visio.base.IVLayers layers();


  @VTID(29)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVLayers.class})
  org.belle.topit.visio.base.IVLayer layers(
  ...
  @VTID(30)
  org.belle.topit.visio.base.IVShape pageSheet();
        ...
        org.belle.topit.visio.base.IVWindow openDrawWindow();
                  ...
                  void nameU(
                    java.lang.String lpLocaleIndependentName);
                         ...
                         * </p>
                         * @return  Returns a value of type test.VisPageTypes
                         */

                        @DISPID(1610743869) //= 0x6002003d. The runtime will prefer the VTID if present
                        @VTID(68)
                        org.belle.topit.visio.base.VisPageTypes type();
                        ...
                        @VTID(73)
                        org.belle.topit.visio.base.IVPage originalPage();
                        ...
                        int[] getShapesLinkedToDataRow(
                          ...
                          int dataRowID);
                              ...
                              @VTID(79)
                              org.belle.topit.visio.base.IVShape dropLinked(
                                com4j.Com4jObject objectToDrop,
                                double x,
                                double y,
                                int dataRecordsetID,
                                ...
                                /**
                                 * @param objectToDrop Mandatory com4j.Com4jObject parameter.
                                 * @param targetShape Mandatory test.IVShape parameter.
                                ...
                                @VTID(85)
                                org.belle.topit.visio.base.IVShape dropConnected(
                                  com4j.Com4jObject objectToDrop,
                                  org.belle.topit.visio.base.IVShape targetShape,
                                  ...
                                  @VTID(87)
                                  org.belle.topit.visio.base.IVShape dropContainer(
                                    com4j.Com4jObject objectToDrop,
                                    com4j.Com4jObject targetShapes);


                                  /**
                                   * @param alignOrSpace Mandatory test.VisLayoutIncrementalType parameter.
                                   * @param alignHorizontal Mandatory test.VisLayoutHorzAlignType parameter.
                                   * @param alignVertical Mandatory test.VisLayoutVertAlignType parameter.
                                   * @param spaceHorizontal Mandatory double parameter.
                                   * @param spaceVertical Mandatory double parameter.
                                   * @param unitsNameOrCode Mandatory test.tagVisUnitCodes parameter.
                                   */

                                  @DISPID(1610743889) //= 0x60020051. The runtime will prefer the VTID if present
                                  @VTID(88)
                                  void layoutIncremental(
                                    org.belle.topit.visio.base.VisLayoutIncrementalType alignOrSpace,
                                    org.belle.topit.visio.base.VisLayoutHorzAlignType alignHorizontal,
                                    org.belle.topit.visio.base.VisLayoutVertAlignType alignVertical,
                                    double spaceHorizontal,
                                    double spaceVertical,
                                    org.belle.topit.visio.base.tagVisUnitCodes unitsNameOrCode);
                                  ...
                                  /**
                                   * @param connectorToSplit Mandatory test.IVShape parameter.
                                  ...
                                  @VTID(91)
                                  org.belle.topit.visio.base.IVShape splitConnector(
                                    org.belle.topit.visio.base.IVShape connectorToSplit,
                                  ...
                                  @VTID(92)
                                  org.belle.topit.visio.base.IVShape dropCallout(
                                    com4j.Com4jObject objectToDrop,
                                    org.belle.topit.visio.base.IVShape targetShape);
                                  ...
                                  /**
                                   * @param nestedOptions Mandatory test.VisContainerNested parameter.
                                   * @return  Returns a value of type int[]
                                   */
                                  ...
                                  @VTID(94)
                                  int[] getContainers(
                                    org.belle.topit.visio.base.VisContainerNested nestedOptions);
                                   ...
                                   * @param populateFlags Mandatory test.VisLegendFlags parameter.
                                   * @return  Returns a value of type test.IVShape
                                   */

                                  @DISPID(1610743899) //= 0x6002005b. The runtime will prefer the VTID if present
                                  @VTID(98)
                                  org.belle.topit.visio.base.IVShape dropLegend(
                                    com4j.Com4jObject outerList,
                                    com4j.Com4jObject innerContainer,
                                    org.belle.topit.visio.base.VisLegendFlags populateFlags);


                                  /**
                                   * @param objectToDrop Mandatory com4j.Com4jObject parameter.
                                   * @param targetList Mandatory test.IVShape parameter.
                                  ...
                                  @VTID(99)
                                  org.belle.topit.visio.base.IVShape dropIntoList(
                                    com4j.Com4jObject objectToDrop,
                                    org.belle.topit.visio.base.IVShape targetList,
                                    int lPosition);
