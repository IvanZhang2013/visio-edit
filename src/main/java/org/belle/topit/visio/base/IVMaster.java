...
public interface IVMaster extends Com4jObject {
  ...
  org.belle.topit.visio.base.IVShape drawOval(
    ...
    double y2);
        ...
        @VTID(43)
        org.belle.topit.visio.base.IVWindow openIconWindow();
        ...
        @VTID(44)
        org.belle.topit.visio.base.IVMaster open();
        ...
        void close();
                  ...
                  @VTID(68)
                  org.belle.topit.visio.base.IVMasterShortcut createShortcut();
                  ...
                  void nameU(
                    java.lang.String lpLocaleIndependentName);
                        ...
                        @VTID(79)
                        org.belle.topit.visio.base.IVMaster editCopy();
                        ...
                        @VTID(80)
                        org.belle.topit.visio.base.IVMaster original();
                         ...
                         * </p>
                         * @return  Returns a value of type test.VisMasterTypes
                         */
                        ...
                        @VTID(98)
                        org.belle.topit.visio.base.VisGraphicPositionHorizontal dataGraphicHorizontalPosition();
                        ...
                        @VTID(100)
                        org.belle.topit.visio.base.VisGraphicPositionVertical dataGraphicVerticalPosition();
                         ...
                         * </p>
                         * @return  Returns a value of type test.IVGraphicItems
                         */

                        @DISPID(1610743903) //= 0x6002005f. The runtime will prefer the VTID if present
                        @VTID(102)
                        org.belle.topit.visio.base.IVGraphicItems graphicItems();


                        @VTID(102)
                        @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVGraphicItems.class})
                        org.belle.topit.visio.base.IVGraphicItem graphicItems(
                          int index);
