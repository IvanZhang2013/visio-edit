...
public interface IVCell extends Com4jObject {
  ...
  /**
   * @param cellObject Mandatory test.IVCell parameter.
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(13)
  void glueTo(
    org.belle.topit.visio.base.IVCell cellObject);
   ...
   * </p>
   * @return  Returns a value of type test.IVRow
   */

  @DISPID(30) //= 0x1e. The runtime will prefer the VTID if present
  @VTID(42)
  org.belle.topit.visio.base.IVRow containingRow();


  @VTID(42)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVRow.class})
  org.belle.topit.visio.base.IVCell containingRow(
  ...
  @VTID(48)
  org.belle.topit.visio.base.IVCell inheritedValueSource();
  ...
  @VTID(49)
  org.belle.topit.visio.base.IVCell inheritedFormulaSource();
