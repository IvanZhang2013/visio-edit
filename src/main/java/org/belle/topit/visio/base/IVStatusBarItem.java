...
@IID("{000D0272-0000-0000-C000-000000000046}")
public interface IVStatusBarItem extends Com4jObject {
  // Methods:
  /**
   */
  ...
  @VTID(11)
  org.belle.topit.visio.base.IVStatusBarItems parent();


  @VTID(11)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVStatusBarItems.class})
  org.belle.topit.visio.base.IVStatusBarItem parent(
    int lIndex);
