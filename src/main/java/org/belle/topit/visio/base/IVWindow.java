...
public interface IVWindow extends Com4jObject {
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVPage pageAsObj();
  ...
  org.belle.topit.visio.base.IVShape selection(
    int index);
  ...
  @VTID(76)
  org.belle.topit.visio.base.IVWindows parent();


  @VTID(76)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVWindows.class})
  org.belle.topit.visio.base.IVWindow parent(
    short index);
   ...
   * </p>
   * @return  Returns a value of type test.IVMasterShortcut
   */

  @DISPID(57) //= 0x39. The runtime will prefer the VTID if present
  @VTID(77)
  org.belle.topit.visio.base.IVMasterShortcut masterShortcut();
  ...
  @VTID(79)
  org.belle.topit.visio.base.IVWindow parentWindow();
  ...
  @VTID(98)
  org.belle.topit.visio.base.IVCell selectedCell();
  ...
  @VTID(99)
  org.belle.topit.visio.base.IVWindow newWindow();
  ...
  @VTID(113)
  org.belle.topit.visio.base.IVCharacters selectedText();
   ...
   * </p>
   * @param ppObjReturn Mandatory test.IVCharacters parameter.
   */

  @DISPID(1610743914) //= 0x6002006a. The runtime will prefer the VTID if present
  @VTID(114)
  void selectedText(
    org.belle.topit.visio.base.IVCharacters ppObjReturn);
   ...
   * </p>
   * @param lpdispRet Mandatory test.IVSelection parameter.
   */

  @DISPID(11) //= 0xb. The runtime will prefer the VTID if present
  @VTID(117)
  void selection(
    org.belle.topit.visio.base.IVSelection lpdispRet);
   ...
   * </p>
   * @return  Returns a value of type test.IVDataRecordset
   */

  @DISPID(1610743919) //= 0x6002006f. The runtime will prefer the VTID if present
  @VTID(118)
  org.belle.topit.visio.base.IVDataRecordset selectedDataRecordset();
   ...
   * </p>
   * @param pIssue Mandatory test.IVValidationIssue parameter.
   */

  @DISPID(1610743924) //= 0x60020074. The runtime will prefer the VTID if present
  @VTID(123)
  void selectedValidationIssue(
    org.belle.topit.visio.base.IVValidationIssue pIssue);
   ...
   * </p>
   * @return  Returns a value of type test.IVValidationIssue
   */

  @DISPID(1610743924) //= 0x60020074. The runtime will prefer the VTID if present
  @VTID(124)
  org.belle.topit.visio.base.IVValidationIssue selectedValidationIssue();


  /**
   * @param sheetObject Mandatory test.IVShape parameter.
   * @param flags Mandatory test.VisCenterViewFlags parameter.
   */
  ...
  void centerViewOnShape(
    org.belle.topit.visio.base.IVShape sheetObject,
    org.belle.topit.visio.base.VisCenterViewFlags flags);
