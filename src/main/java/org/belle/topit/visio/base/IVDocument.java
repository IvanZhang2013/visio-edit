...
public interface IVDocument extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.IVMasters
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(11)
  org.belle.topit.visio.base.IVMasters masters();


  @VTID(11)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVMasters.class})
  org.belle.topit.visio.base.IVMaster masters(
   ...
   * </p>
   * @return  Returns a value of type test.IVPages
   */

  @DISPID(7) //= 0x7. The runtime will prefer the VTID if present
  @VTID(12)
  org.belle.topit.visio.base.IVPages pages();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVPages.class})
  org.belle.topit.visio.base.IVPage pages(
   ...
   * </p>
   * @return  Returns a value of type test.IVStyles
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(13)
  org.belle.topit.visio.base.IVStyles styles();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVStyles.class})
  org.belle.topit.visio.base.IVStyle styles(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
  ...
  @VTID(38)
  org.belle.topit.visio.base.IVUIObject customMenus();


  /**
   * @param menusObject Mandatory test.IVUIObject parameter.
   */

  @DISPID(25) //= 0x19. The runtime will prefer the VTID if present
  @VTID(39)
  void setCustomMenus(
    org.belle.topit.visio.base.IVUIObject menusObject);
  ...
  @VTID(43)
  org.belle.topit.visio.base.IVUIObject customToolbars();


  /**
   * @param toolbarsObject Mandatory test.IVUIObject parameter.
   */

  @DISPID(29) //= 0x1d. The runtime will prefer the VTID if present
  @VTID(44)
  void setCustomToolbars(
    org.belle.topit.visio.base.IVUIObject toolbarsObject);
   ...
   * </p>
   * @return  Returns a value of type test.IVFonts
   */

  @DISPID(32) //= 0x20. The runtime will prefer the VTID if present
  @VTID(48)
  org.belle.topit.visio.base.IVFonts fonts();


  @VTID(48)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVFonts.class})
  org.belle.topit.visio.base.IVFont fonts(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
   ...
   * </p>
   * @return  Returns a value of type test.IVColors
   */

  @DISPID(33) //= 0x21. The runtime will prefer the VTID if present
  @VTID(49)
  org.belle.topit.visio.base.IVColors colors();


  @VTID(49)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVColors.class})
  org.belle.topit.visio.base.IVColor colors(
    int index);
  ...
  @VTID(88)
  org.belle.topit.visio.base.IVWindow openStencilWindow();
   ...
   * </p>
   * @return  Returns a value of type test.IVOLEObjects
   */

  @DISPID(65) //= 0x41. The runtime will prefer the VTID if present
  @VTID(100)
  org.belle.topit.visio.base.IVOLEObjects oleObjects();


  @VTID(100)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVOLEObjects.class})
  org.belle.topit.visio.base.IVOLEObject oleObjects(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
  ...
  @VTID(110)
  org.belle.topit.visio.base.IVShape documentSheet();
   ...
   * </p>
   * @return  Returns a value of type test.IVMasterShortcuts
   */

  @DISPID(75) //= 0x4b. The runtime will prefer the VTID if present
  @VTID(114)
  org.belle.topit.visio.base.IVMasterShortcuts masterShortcuts();


  @VTID(114)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVMasterShortcuts.class})
  org.belle.topit.visio.base.IVMasterShortcut masterShortcuts(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
  ...
  @VTID(117)
  org.belle.topit.visio.base.IVShape gestureFormatSheet();
   ...
   * </p>
   * @return  Returns a value of type test.tagVisDocVersions
   */

  @DISPID(1610743924) //= 0x60020074. The runtime will prefer the VTID if present
  @VTID(123)
  org.belle.topit.visio.base.tagVisDocVersions version();
   ...
   * </p>
   * @param lpi4Ret Mandatory test.tagVisDocVersions parameter.
   */

  @DISPID(1610743924) //= 0x60020074. The runtime will prefer the VTID if present
  @VTID(124)
  void version(
    org.belle.topit.visio.base.tagVisDocVersions lpi4Ret);
   ...
   * </p>
   * @return  Returns a value of type test.tagVisSavePreviewMode
   */

  @DISPID(1610743926) //= 0x60020076. The runtime will prefer the VTID if present
  @VTID(125)
  org.belle.topit.visio.base.tagVisSavePreviewMode savePreviewMode();
   ...
   * </p>
   * @param lpi4Ret Mandatory test.tagVisSavePreviewMode parameter.
   */

  @DISPID(1610743926) //= 0x60020076. The runtime will prefer the VTID if present
  @VTID(126)
  void savePreviewMode(
    org.belle.topit.visio.base.tagVisSavePreviewMode lpi4Ret);
   ...
   * </p>
   * @return  Returns a value of type test.tagVisPaperSizes
   */

  @DISPID(1610743936) //= 0x60020080. The runtime will prefer the VTID if present
  @VTID(135)
  org.belle.topit.visio.base.tagVisPaperSizes paperSize();
   ...
   * </p>
   * @param lpi4Ret Mandatory test.tagVisPaperSizes parameter.
   */

  @DISPID(1610743936) //= 0x60020080. The runtime will prefer the VTID if present
  @VTID(136)
  void paperSize(
    org.belle.topit.visio.base.tagVisPaperSizes lpi4Ret);
   ...
   * </p>
   * @return  Returns a value of type test.tagVisDocModeArgs
   */

  @DISPID(1610743938) //= 0x60020082. The runtime will prefer the VTID if present
  @VTID(137)
  org.belle.topit.visio.base.tagVisDocModeArgs mode();
   ...
   * </p>
   * @param lpi4Ret Mandatory test.tagVisDocModeArgs parameter.
   */

  @DISPID(1610743938) //= 0x60020082. The runtime will prefer the VTID if present
  @VTID(138)
  void mode(
    org.belle.topit.visio.base.tagVisDocModeArgs lpi4Ret);
   ...
   * </p>
   * @return  Returns a value of type test.tagVisSnapSettings
   */

  @DISPID(1610743942) //= 0x60020086. The runtime will prefer the VTID if present
  @VTID(141)
  org.belle.topit.visio.base.tagVisSnapSettings snapSettings();
   ...
   * </p>
   * @param pnRet Mandatory test.tagVisSnapSettings parameter.
   */

  @DISPID(1610743942) //= 0x60020086. The runtime will prefer the VTID if present
  @VTID(142)
  void snapSettings(
    org.belle.topit.visio.base.tagVisSnapSettings pnRet);
   ...
   * </p>
   * @return  Returns a value of type test.tagVisSnapExtensions
   */

  @DISPID(1610743944) //= 0x60020088. The runtime will prefer the VTID if present
  @VTID(143)
  org.belle.topit.visio.base.tagVisSnapExtensions snapExtensions();
   ...
   * </p>
   * @param pnRet Mandatory test.tagVisSnapExtensions parameter.
   */

  @DISPID(1610743944) //= 0x60020088. The runtime will prefer the VTID if present
  @VTID(144)
  void snapExtensions(
    org.belle.topit.visio.base.tagVisSnapExtensions pnRet);
  ...
  double[] snapAngles();
     ...
     * </p>
     * @return  Returns a value of type test.tagVisGlueSettings
     */

    @DISPID(1610743950) //= 0x6002008e. The runtime will prefer the VTID if present
    @VTID(149)
    org.belle.topit.visio.base.tagVisGlueSettings glueSettings();
     ...
     * </p>
     * @param pnRet Mandatory test.tagVisGlueSettings parameter.
     */

    @DISPID(1610743950) //= 0x6002008e. The runtime will prefer the VTID if present
    @VTID(150)
    void glueSettings(
      org.belle.topit.visio.base.tagVisGlueSettings pnRet);
     ...
     * @return  Returns a value of type test.tagVisProtection
     */

    @DISPID(1610743956) //= 0x60020094. The runtime will prefer the VTID if present
    @VTID(155)
    org.belle.topit.visio.base.tagVisProtection protection(
     ...
     * </p>
     * @param bstrPassword Optional parameter. Default value is com4j.Variant.getMissing()
     * @param pnRet Mandatory test.tagVisProtection parameter.
     */
    ...
    void protection(
      @Optional @MarshalAs(NativeType.VARIANT) java.lang.Object bstrPassword,
      org.belle.topit.visio.base.tagVisProtection pnRet);
     ...
     * </p>
     * @param pSourceDoc Mandatory test.IVDocument parameter.
     */

    @DISPID(1610743993) //= 0x600200b9. The runtime will prefer the VTID if present
    @VTID(192)
    void copyPreviewPicture(
      org.belle.topit.visio.base.IVDocument pSourceDoc);
     ...
     * </p>
     * @return  Returns a value of type test.tagVisZoomBehavior
     */

    @DISPID(1610744007) //= 0x600200c7. The runtime will prefer the VTID if present
    @VTID(206)
    org.belle.topit.visio.base.tagVisZoomBehavior zoomBehavior();
     ...
     * </p>
     * @param pnZoomBehavior Mandatory test.tagVisZoomBehavior parameter.
     */

    @DISPID(1610744007) //= 0x600200c7. The runtime will prefer the VTID if present
    @VTID(207)
    void zoomBehavior(
      org.belle.topit.visio.base.tagVisZoomBehavior pnZoomBehavior);
     ...
     * </p>
     * @return  Returns a value of type test.VisDocumentTypes
     */

    @DISPID(1610744011) //= 0x600200cb. The runtime will prefer the VTID if present
    @VTID(210)
    org.belle.topit.visio.base.VisDocumentTypes type();
    ...
    /**
     * @param printRange Mandatory test.VisPrintOutRange parameter.
    ...
    @VTID(215)
    void printOut(
      org.belle.topit.visio.base.VisPrintOutRange printRange,
     ...
     * </p>
     * @return  Returns a value of type test.IVDataRecordsets
     */

    @DISPID(1610744027) //= 0x600200db. The runtime will prefer the VTID if present
    @VTID(226)
    org.belle.topit.visio.base.IVDataRecordsets dataRecordsets();


    @VTID(226)
    @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVDataRecordsets.class})
    org.belle.topit.visio.base.IVDataRecordset dataRecordsets(
      int index);

    /**
     * @param eType Mandatory test.VisThemeTypes parameter.
     * @return  Returns a value of type java.lang.String[]
     */
    ...
    java.lang.String[] getThemeNames(
      org.belle.topit.visio.base.VisThemeTypes eType);
    ...
    /**
     * @param fixedFormat Mandatory test.VisFixedFormatTypes parameter.
     * @param outputFileName Mandatory java.lang.String parameter.
     * @param intent Mandatory test.VisDocExIntent parameter.
     * @param printRange Mandatory test.VisPrintOutRange parameter.
     * @param fromPage Optional parameter. Default value is 1
     * @param toPage Optional parameter. Default value is -1
     * @param colorAsBlack Optional parameter. Default value is false
    ...
    void exportAsFixedFormat(
      org.belle.topit.visio.base.VisFixedFormatTypes fixedFormat,
      java.lang.String outputFileName,
      org.belle.topit.visio.base.VisDocExIntent intent,
      org.belle.topit.visio.base.VisPrintOutRange printRange,
      @Optional @DefaultValue("1") int fromPage,
      @Optional @DefaultValue("-1") int toPage,
      @Optional @DefaultValue("0") boolean colorAsBlack,
     ...
     * </p>
     * @return  Returns a value of type test.IVServerPublishOptions
     */

    @DISPID(1610744041) //= 0x600200e9. The runtime will prefer the VTID if present
    @VTID(240)
    org.belle.topit.visio.base.IVServerPublishOptions serverPublishOptions();
     ...
     * </p>
     * @return  Returns a value of type test.IVValidation
     */

    @DISPID(1610744042) //= 0x600200ea. The runtime will prefer the VTID if present
    @VTID(241)
    org.belle.topit.visio.base.IVValidation validation();


    @VTID(241)
    @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVValidation.class,org.belle.topit.visio.base.IVValidationIssues.class})
    org.belle.topit.visio.base.IVValidationIssue validation(
      int index);
