...
public interface IVStatusBar extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.IVStatusBarItems
   */

  @DISPID(1610743813) //= 0x60020005. The runtime will prefer the VTID if present
  @VTID(12)
  org.belle.topit.visio.base.IVStatusBarItems statusBarItems();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVStatusBarItems.class})
  org.belle.topit.visio.base.IVStatusBarItem statusBarItems(
    int lIndex);
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVStatusBars parent();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVStatusBars.class})
  org.belle.topit.visio.base.IVStatusBar parent(
    int lIndex);
