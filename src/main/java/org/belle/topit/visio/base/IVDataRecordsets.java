...
public interface IVDataRecordsets extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(12)
  @DefaultMethod
  org.belle.topit.visio.base.IVDataRecordset item(
    int index);
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVDataRecordset itemFromID(
    int id);
  ...
  @VTID(16)
  org.belle.topit.visio.base.IVDataRecordset add(
  ...
  @VTID(17)
  org.belle.topit.visio.base.IVDataRecordset addFromXML(
  ...
  @VTID(18)
  org.belle.topit.visio.base.IVDataRecordset addFromConnectionFile(
