...
public interface IVConnects extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type test.IVConnect
   */

  @DISPID(999) //= 0x3e7. The runtime will prefer the VTID if present
  @VTID(8)
  org.belle.topit.visio.base.IVConnect item16(
    short index);
  ...
  @VTID(10)
  org.belle.topit.visio.base.IVShape fromSheet();
  ...
  @VTID(14)
  org.belle.topit.visio.base.IVShape toSheet();
  ...
  @VTID(15)
  @DefaultMethod
  org.belle.topit.visio.base.IVConnect item(
    int index);
