...
public interface IVValidationRuleSets extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(12)
  @DefaultMethod
  org.belle.topit.visio.base.IVValidationRuleSet item(
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVValidationRuleSet itemFromID(
    int ruleID);
  ...
  @VTID(15)
  org.belle.topit.visio.base.IVValidationRuleSet add(
  ...
  @VTID(16)
  org.belle.topit.visio.base.IVValidationRuleSet addCopy(
