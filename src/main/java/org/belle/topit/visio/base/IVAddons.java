...
public interface IVAddons extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type test.IVAddon
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(9)
  @DefaultMethod
  org.belle.topit.visio.base.IVAddon item(
  ...
  @VTID(11)
  org.belle.topit.visio.base.IVAddon add(
  ...
  @VTID(14)
  org.belle.topit.visio.base.IVAddon itemU(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
