...
public interface IVMasterShortcuts extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(11)
  @DefaultMethod
  org.belle.topit.visio.base.IVMasterShortcut item(
  ...
  @VTID(14)
  org.belle.topit.visio.base.IVMasterShortcut drop(
  ...
  @VTID(15)
  org.belle.topit.visio.base.IVMasterShortcut itemU(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
  ...
  @VTID(18)
  org.belle.topit.visio.base.IVMasterShortcut itemFromID(
    int nID);
