...
public interface IVUIObject extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.IVMenuSets
   */

  @DISPID(1610743814) //= 0x60020006. The runtime will prefer the VTID if present
  @VTID(13)
  org.belle.topit.visio.base.IVMenuSets menuSets();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVMenuSets.class})
  org.belle.topit.visio.base.IVMenuSet menuSets(
    int lIndex);
   ...
   * </p>
   * @return  Returns a value of type test.IVToolbarSets
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(14)
  org.belle.topit.visio.base.IVToolbarSets toolbarSets();


  @VTID(14)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVToolbarSets.class})
  org.belle.topit.visio.base.IVToolbarSet toolbarSets(
    int lIndex);
   ...
   * </p>
   * @return  Returns a value of type test.IVStatusBars
   */

  @DISPID(1610743816) //= 0x60020008. The runtime will prefer the VTID if present
  @VTID(15)
  org.belle.topit.visio.base.IVStatusBars statusBars();


  @VTID(15)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVStatusBars.class})
  org.belle.topit.visio.base.IVStatusBar statusBars(
    int lIndex);
   ...
   * </p>
   * @return  Returns a value of type test.IVAccelTables
   */

  @DISPID(1610743817) //= 0x60020009. The runtime will prefer the VTID if present
  @VTID(16)
  org.belle.topit.visio.base.IVAccelTables accelTables();


  @VTID(16)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVAccelTables.class})
  org.belle.topit.visio.base.IVAccelTable accelTables(
    int lIndex);
  ...
  @VTID(28)
  org.belle.topit.visio.base.IVUIObject clone();
