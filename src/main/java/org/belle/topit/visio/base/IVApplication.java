...
public interface IVApplication extends Com4jObject {
  ...
  @VTID(31)
  org.belle.topit.visio.base.IVUIObject builtInMenus();
  ...
  @VTID(32)
  org.belle.topit.visio.base.IVUIObject builtInToolbars(
    short fIgnored);
  ...
  /**
   * @param uStateID Mandatory test.tagVisOnComponentEnterCodes parameter.
  ...
  void onComponentEnterState(
    org.belle.topit.visio.base.tagVisOnComponentEnterCodes uStateID,
    boolean bEnter);
  ...
  @VTID(138)
  org.belle.topit.visio.base.tagVisZoomBehavior defaultZoomBehavior();
   ...
   * </p>
   * @return  Returns a value of type test.IVApplicationSettings
   */

  @DISPID(1610743947) //= 0x6002008b. The runtime will prefer the VTID if present
  @VTID(146)
  org.belle.topit.visio.base.IVApplicationSettings settings();
   ...
   * @param targetDocument Mandatory test.IVDocument parameter.
   * @param targetModes Mandatory test.VisRibbonXModes parameter.
  ...
  void registerRibbonX(
    ...
    org.belle.topit.visio.base.IVDocument targetDocument,
    org.belle.topit.visio.base.VisRibbonXModes targetModes,
  ...
  /**
   * @param stencilType Mandatory test.VisBuiltInStencilTypes parameter.
   * @param measurementSystem Mandatory test.VisMeasurementSystem parameter.
   * @return  Returns a value of type java.lang.String
   */
  ...
  java.lang.String getBuiltInStencilFile(
    org.belle.topit.visio.base.VisBuiltInStencilTypes stencilType,
    org.belle.topit.visio.base.VisMeasurementSystem measurementSystem);
   ...
   * </p>
   * @return  Returns a value of type test.VisEdition
   */

  @DISPID(1610743965) //= 0x6002009d. The runtime will prefer the VTID if present
  @VTID(164)
  org.belle.topit.visio.base.VisEdition currentEdition();
