...
public interface IEnumVMenuSet extends Com4jObject {
   ...
   * @param rgelt Mandatory Holder<test.IVMenuSet> parameter.
  ...
  void next(
    int celt,
    Holder<org.belle.topit.visio.base.IVMenuSet> rgelt,
  ...
  /**
   * @return  Returns a value of type test.IEnumVMenuSet
   */

  @VTID(6)
  org.belle.topit.visio.base.IEnumVMenuSet clone();
