...
public interface IVStyles extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(9)
  @DefaultMethod
  org.belle.topit.visio.base.IVStyle item(
  ...
  @VTID(12)
  org.belle.topit.visio.base.IVStyle add(
  ...
  @VTID(16)
  org.belle.topit.visio.base.IVStyle itemFromID16(
    short objectID);
  ...
  @VTID(19)
  org.belle.topit.visio.base.IVStyle itemFromID(
    int objectID);
  ...
  @VTID(20)
  org.belle.topit.visio.base.IVStyle itemU(
    @MarshalAs(NativeType.VARIANT) java.lang.Object nameOrIndex);
