...
@IID("{000D0714-0000-0000-C000-000000000046}")
public interface IVFont extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Getter method for the COM property "PitchAndFamily"
   * </p>
   * @return  Returns a value of type short
   */
