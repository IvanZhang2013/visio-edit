...
public interface IVCharacters extends Com4jObject {
  ...
  /**
   * @param category Mandatory test.tagVisFieldCategories parameter.
   * @param code Mandatory test.tagVisFieldCodes parameter.
   * @param format Mandatory test.tagVisFieldFormats parameter.
  ...
  @VTID(42)
  void addFieldEx(
    org.belle.topit.visio.base.tagVisFieldCategories category,
    org.belle.topit.visio.base.tagVisFieldCodes code,
    org.belle.topit.visio.base.tagVisFieldFormats format,
