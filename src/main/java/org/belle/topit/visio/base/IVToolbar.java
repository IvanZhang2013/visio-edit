...
public interface IVToolbar extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.IVToolbarItems
   */

  @DISPID(1610743813) //= 0x60020005. The runtime will prefer the VTID if present
  @VTID(12)
  org.belle.topit.visio.base.IVToolbarItems toolbarItems();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVToolbarItems.class})
  org.belle.topit.visio.base.IVToolbarItem toolbarItems(
    int lIndex);
   ...
   * </p>
   * @return  Returns a value of type test.IVToolbars
   */

  @DISPID(1610743814) //= 0x60020006. The runtime will prefer the VTID if present
  @VTID(13)
  org.belle.topit.visio.base.IVToolbars parent();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVToolbars.class})
