...
public interface IVValidationRule extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.VisRuleTargets
   */

  @DISPID(1610743823) //= 0x6002000f. The runtime will prefer the VTID if present
  @VTID(22)
  org.belle.topit.visio.base.VisRuleTargets targetType();
   ...
   * </p>
   * @param targetType Mandatory test.VisRuleTargets parameter.
   */
   ...
   * </p>
   * @return  Returns a value of type test.IVValidationRuleSet
   */
  ...
  @VTID(28)
  org.belle.topit.visio.base.IVValidationIssue addIssue(
    @Optional org.belle.topit.visio.base.IVPage targetPage,
    @Optional org.belle.topit.visio.base.IVShape targetShape);
