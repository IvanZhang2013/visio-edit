...
public interface IEnumVToolbarItem extends Com4jObject {
   ...
   * @param rgelt Mandatory Holder<test.IVToolbarItem> parameter.
  ...
  void next(
    int celt,
    Holder<org.belle.topit.visio.base.IVToolbarItem> rgelt,
  ...
  /**
   * @return  Returns a value of type test.IEnumVToolbarItem
   */

  @VTID(6)
  org.belle.topit.visio.base.IEnumVToolbarItem clone();
