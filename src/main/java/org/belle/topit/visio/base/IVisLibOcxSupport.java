...
public interface IVisLibOcxSupport extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.VisPageSizingBehaviors
   */

  @VTID(14)
  org.belle.topit.visio.base.VisPageSizingBehaviors pageSizingBehavior();
   ...
   * </p>
   * @param peVal Mandatory test.VisPageSizingBehaviors parameter.
   */

  @VTID(15)
  void pageSizingBehavior(
    org.belle.topit.visio.base.VisPageSizingBehaviors peVal);
