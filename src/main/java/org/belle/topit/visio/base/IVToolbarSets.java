...
public interface IVToolbarSets extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(8)
  @DefaultMethod
  org.belle.topit.visio.base.IVToolbarSet item(
    int lIndex);
  ...
  @VTID(9)
  org.belle.topit.visio.base.IVToolbarSet itemAtID(
    int lID);
  ...
  @VTID(10)
  org.belle.topit.visio.base.IVToolbarSet add();
  ...
  @VTID(11)
  org.belle.topit.visio.base.IVToolbarSet addAtID(
    int lID);
