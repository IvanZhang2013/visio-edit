...
public interface IEnumVToolbar extends Com4jObject {
   ...
   * @param rgelt Mandatory Holder<test.IVToolbar> parameter.
  ...
  void next(
    int celt,
    Holder<org.belle.topit.visio.base.IVToolbar> rgelt,
  ...
  /**
   * @return  Returns a value of type test.IEnumVToolbar
   */

  @VTID(6)
  org.belle.topit.visio.base.IEnumVToolbar clone();
