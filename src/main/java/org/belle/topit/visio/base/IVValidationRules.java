...
public interface IVValidationRules extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type test.IVValidationRule
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(12)
  @DefaultMethod
  org.belle.topit.visio.base.IVValidationRule item(
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVValidationRule itemFromID(
    int ruleID);
  ...
  @VTID(15)
  org.belle.topit.visio.base.IVValidationRule add(
