...
public interface IVDataRecordset extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type test.VisLinkReplaceBehavior
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(14)
  org.belle.topit.visio.base.VisLinkReplaceBehavior linkReplaceBehavior();
   ...
   * </p>
   * @param property Mandatory test.VisLinkReplaceBehavior parameter.
   */

  @DISPID(1610743815) //= 0x60020007. The runtime will prefer the VTID if present
  @VTID(15)
  void linkReplaceBehavior(
    org.belle.topit.visio.base.VisLinkReplaceBehavior property);
   ...
   * </p>
   * @return  Returns a value of type test.IVDataConnection
   */

  @DISPID(1610743817) //= 0x60020009. The runtime will prefer the VTID if present
  @VTID(16)
  org.belle.topit.visio.base.IVDataConnection dataConnection();
   ...
   * </p>
   * @return  Returns a value of type test.IVDataColumns
   */

  @DISPID(1610743818) //= 0x6002000a. The runtime will prefer the VTID if present
  @VTID(17)
  org.belle.topit.visio.base.IVDataColumns dataColumns();


  @VTID(17)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVDataColumns.class})
  org.belle.topit.visio.base.IVDataColumn dataColumns(
    @MarshalAs(NativeType.VARIANT) java.lang.Object indexOrName);
      ...
      /**
       * @param shapeInConflict Mandatory test.IVShape parameter.
       */

      @DISPID(1610743836) //= 0x6002001c. The runtime will prefer the VTID if present
      @VTID(35)
      void removeRefreshConflict(
        org.belle.topit.visio.base.IVShape shapeInConflict);
