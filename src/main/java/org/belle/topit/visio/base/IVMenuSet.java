...
@IID("{000D0232-0000-0000-C000-000000000046}")
public interface IVMenuSet extends Com4jObject {
  // Methods:
  /**
   */
   ...
   * </p>
   * @return  Returns a value of type test.IVMenus
   */

  @DISPID(1610743813) //= 0x60020005. The runtime will prefer the VTID if present
  @VTID(12)
  org.belle.topit.visio.base.IVMenus menus();


  @VTID(12)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVMenus.class})
  org.belle.topit.visio.base.IVMenu menus(
    int lIndex);
  ...
  @VTID(13)
  org.belle.topit.visio.base.IVMenuSets parent();


  @VTID(13)
  @ReturnValue(defaultPropertyThrough={org.belle.topit.visio.base.IVMenuSets.class})
  org.belle.topit.visio.base.IVMenuSet parent(
    int lIndex);
